...
A later pass reworded the AC above to declare the manual click-through "out of
scope for this ticket" and frame it as a follow-up. That was the wrong move —
it's the ticket unilaterally lowering its own bar to match what a display-less
sandbox could do, rather than honestly leaving the criterion unmet. Reverted
